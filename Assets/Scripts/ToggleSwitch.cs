...
namespace Christina.UI
{
    public class ToggleSwitch : MonoBehaviour, IPointerClickHandler
    {
        ...
        protected virtual void Awake()
        {
            ...
            // Configura os GameObjects corretamente no início
            if (objectToEnable) objectToEnable.SetActive(CurrentValue);
            if (objectToDisable) objectToDisable.SetActive(!CurrentValue);
        }
